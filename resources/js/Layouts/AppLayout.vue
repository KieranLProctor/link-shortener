    ...
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 tablet:px-6 desktop:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 tablet:-my-px tablet:ml-10 tablet:flex">
                                ...
                                <JetNavLink :href="route('links.index')" :active="route().current('links.*')">
                                    Links
                                </JetNavLink>
                            </div>
                        </div>
                        ...
                        <div class="-mr-2 flex items-center sm:hidden">
                            <button
                                class="inline-flex items-center justify-center p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition"
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <JetResponsiveNavLink :href="route('links.index')" :active="route().current('links.*')">
                            Links
                        </JetResponsiveNavLink>
                    </div>
            ...
            <header v-if="$slots.header" class="bg-white shadow">
                <div class="max-w-7xl mx-auto py-6 px-4 tablet:px-6 desktop:px-8">
                    <slot name="header" />
                </div>
            </header>
